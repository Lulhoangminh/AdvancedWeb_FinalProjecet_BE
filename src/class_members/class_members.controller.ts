...
export class ClassMembersController {
  ...
  async findOne(@Param('student_id') student_id?: string, @Param('class_id') class_id?: string) {
  ...
  @ApiOkResponse({ type: ClassMemberEntity })
  remove(@Param('student_id') student_id: string, @Param('class_id') class_id: string) {
